...
descriptions = {
    "and_in_import_statement": {
        "in cause": "only be used for boolean expressions",
    ...
    "assign_to_ellipsis": {
        "in cause": "The ellipsis symbol `...` is a constant in Python",
        title: "Assignment to Ellipsis symbol",
    },
    "assign_to_f_string": {
        "in cause": "expression that has the f-string",
        title: "Cannot assign to f-string",
    },
    "assign_to_function_call_1": {
        "in cause": "function call and is not simply the name of a variable",
        title: "Cannot assign to function call: single = sign",
        "also in cause": ["len('a')"],
    },
    "assign_to_function_call_2": {
        "in cause": "function call and not the name of a variable",
        title: "Cannot assign to function call: two = signs",
        "also in cause": ["func(...)"],
    },
    "assign_to_generator": {
        "in cause": "generator expression instead of the name of a variable",
        title: "Assign to generator expression",
    },
    "assign_to_literal_dict": {
        "in cause": "is or includes an actual object of type `dict`",
        title: "Cannot assign to literal - 4",
    },
    "assign_to_literal_int": {
        "in cause": "is or includes an actual object of type `int`",
    ...
    "assign_to_literal_int_3": {
        "in cause": "is or includes an actual object",
        title: "Cannot assign to literal - 5",
    },
    "assign_to_literal_set": {
        "in cause": "is or includes an actual object of type `set`",
        title: "Cannot assign to literal - 3",
    },
    "assign_to_keyword_def": {  # = sign is flagged
        "in cause": "assign a value to the Python keyword `def`",
        title: "Assign to keyword def",
    },
    "assign_to_keyword_else": {  # else is flagged
        "in cause": "assign a value to the Python keyword `else`",
        title: "Assign to keyword else",
    },
    "assign_to_keyword_none": {
        "in cause": "`None` is a constant in Python",
        title: "Assignment to keyword (None)",
    },
    "assign_to_operation": {
        "in cause": "only used to assign a value to a variable",
        title: "Assign to math operation",
    },
    "assign_to_yield_expression": {
        "in cause": "You wrote an expression that includes the `yield` keyword",
    ...
    "assignment_expression_cannot_rebind": {
        "in cause": "a comprehension to assign a value to the iteration variable",
    ...
    "comprehension_with_condition_no_else": {
        "in cause": "The correct order depends if there is an `else` clause or not",
    ...
    "continue_outside_loop": {
        "in cause": "The Python keyword `continue` can only be used",
        title: "continue outside loop",
    },
    "copy_pasted_code": {
        "in cause": "copy-pasted code from an interactive interpreter",
    ...
    "def_arg_after_kwarg": {
        "in cause": "Positional arguments must come before keyword argument",
        title: "def: positional arg after kwargs",
    },
    "def_bare_star_arg": {
        "in cause": "replace `*` by either `*arguments` or ",
        title: "def: named arguments must follow bare *",
    },
    "def_code_block": {
        "in cause": "tried to define a function and did not",
        title: "def: misused as code block",
    },
    "def_code_block_2": {
        "in cause": "tried to define a function or method and did not",
        title: "def: misused as code block - 2",
    },
    "def_dotted_argument": {
        "in cause": "You cannot use dotted names as function arguments.",
    ...
    "def_dotted_function_name": {
        "in cause": "You cannot use dots in function names.",
        title: "Dotted function name",
    },
    "def_dict_as_arg": {
        "in cause": "You cannot have any explicit dict or set as function arguments",
        title: "def: dict as argument",
    },
    "def_duplicate_arg": {
        "in cause": "keyword argument should appear only once in a function definition",
    ...
    "def_forward_slash_2": {
        "in cause": "When they are used together, `/` must appear before `*`",
        title: "def: / before star",
    },
    "def_forward_slash_3": {
        "in cause": "`*arg` must appear after `/` in a function definition",
        title: "def: / before star arg",
    },
    "def_forward_slash_4": {
        "in cause": "You can only use `/` once in a function definition",
        title: "def: / used twice",
    },
    "def_function_name_invalid": {
        "in cause": "The name of a function must be a valid Python identifier",
        title: "def: non-identifier as a function name",
    },
    "def_function_name_string": {
        "in cause": "use a string as a function name",
        title: "def: using a string as a function name",
    },
    "def_keyword_as_arg_1": {
        "in cause": "as an argument in the definition of a function",
    ...
    "def_keyword_as_name": {
        "in cause": "You tried to use the Python keyword",
        title: "def: Python keyword as function name",
    },
    "def_list_as_arg_1": {
        "in cause": "You cannot have explicit lists as function arguments",
    ...
    "def_missing_colon": {
        "in cause": "Did you forget to write a colon",
        title: "def: missing colon",
    },
    "def_missing_comma": {
        "in cause": "Did you forget a comma",
    ...
    "def_star_arg_before_slash": {
        "in cause": "`*arg` must appear after `/` ",
        title: "def: ``*arg`` before /",
    },
    "def_star_used_only_once": {
        "in cause": "can only use `*` once in a function definition",
        title: "def: ``*`` used twice",
        "also in cause": ["`*arg`"],
    },
    ...
    "def_string_as_arg": {
        "in cause": "You used a string as an argument",
    ...
    "delete_names_or_items": {
        "in cause": "You can only delete names of objects, or items in mutable containers",
    ...
    "invalid_identifier_2": {
        "in cause": "Perhaps you forgot a multiplication operator",
    ...
    "invalid_keyword_argument": {
        "in cause": "where `invalid` is not a valid ",
        title: "Keyword can't be an expression",
    },
    "invalid_octal": {
        "in cause": "Did you made a mistake in writing an octal integer",
        title: "Invalid octal number",
    },
    "inverted_operators": {
        "in cause": "Did you write operators in an incorrect order?",
    ...
    "missing_in_with_for": {
        "in cause": "Did you forget to write `in`?",
        title: "For loop missing 'in' operator",
    },
    "missing_parens_for_range": {
        "in cause": "you forgot to use to use parenthesis with `range`",
        title: "Missing parenthesis for range",
    },
    "misspelled_keyword": {
        "in cause": "if i in range(3)",
        title: "Misspelled Python keyword",
    },
    "name_is_global_and_nonlocal": {
        "in cause": "You declared `xy` as being both a global and nonlocal",
        title: "Name is global and nonlocal",
    },
    "name_is_param_and_nonlocal": {
        "in cause": "You used `x` as a parameter for a function",
        title: "Name is parameter and nonlocal",
    },
    "no_binding_for_nonlocal": {
        "in cause": "nonlocal variable but it cannot be found.",
        title: "nonlocal variable not found",
    },
    "nonlocal_at_module": {
        "in cause": "You used the nonlocal keyword at a module level",
        title: "nonlocal variable not found at module level",
    },
    "operator_twice_in_a_row": {
        "in cause": "You cannot have write the same operator, `**`, twice in a row",
        title: "Same operator twice in a row",
    },
    "pip_install_1": {
        "in cause": "`pip` is a command that needs to run in a terminal",
    ...
    "print_is_a_function": {
        "in cause": "In older version of Python, `print` was a keyword",
    ...
    "python_interpreter": {
        "in cause": " attempting to use Python to run a program",
        title: "Calling python from interpreter",
    },
    "python_not_interpreter": {
        "in cause": "Did you forget something between `a` and `b`",
        title: "problem with assigning a variable to Python",
    },
    "quote_inside_string": {
        "in cause": "quote inside a string",
        title: "Quote inside a string",
    },
    "raise_multiple_exceptions": {
        "in cause": "trying to raise an exception using Python 2 syntax.",
        title: "Raising multiple exceptions",
    },
    "return_outside_function": {
        "in cause": "You can only use a `return`",
        title: "Cannot use return outside function",
    },
    "semi_colon_instead_of_comma_1": {
        "in cause": "You wrote a semi-colon, `;`, where a comma was expected.",
        title: "Semi-colon instead of comma - 1",
    },
    "semi_colon_instead_of_comma_2": {
        "in cause": "You wrote semi-colons, `;`, where commas were expected.",
    ...
    "space_between_operators_1": {
        "in cause": "meant to write `**` as a single operator",
    ...
    "space_in_variable_name": {
        "in cause": "You cannot have spaces in identifiers (variable names).",
        title: "Space in variable name",
    },
    "star_assignment_target": {
        "in cause": "list_or_tuple",
        title: "Wrong target for star assignment",
    },
    "too_many_nested_blocks": {
        "in cause": "you need to reduce the number",
    ...
    "too_many_parentheses": {
        "in cause": "you need to reduce the number of parentheses",
        title: "Too many nested parentheses.",
    },
    "trailing_comma_in_import": {
        "in cause": "However, if you remove the last comma, there will be no syntax error",
        title: "Trailing comma in import statement",
    },
    "triple_equal": {
        "in cause": "the exact same object, use the operator `is`",
        title: "Triple-equal sign",
    },
    "unclosed_bracket": {
        "in cause": "The opening square bracket `[`",
        title: "Unclosed bracket",
    },
    "unclosed_paren_1": {
        "in cause": "The opening parenthesis `(` on line",
    ...
    "unclosed_paren_3": {
        "in cause": "The opening parenthesis `(` on line 5 is not closed",
        title: "Unclosed parenthesis - 3",
    },
    "unclosed_paren_4": {
        "in cause": "The opening parenthesis `(` on line 2 is not closed",
        title: "Unclosed parenthesis - 4",
    },
    "unexpected_after_continuation_character": {
        "in cause": "using the continuation character",
    ...
    "unicode_fraction": {
        "in cause": "that you meant to write the fraction",
    ...
    "unicode_fraction3": {
        "in cause": "but is different from the division operator",
        title: "Invalid character (unicode fraction slash)",
    },
    "unicode_quote": {
        "in cause": "fancy unicode quotation mark",
    ...
    "unterminated_triple_quote_string": {
        "in cause": "You started writing a triple-quoted string",
        title: "Unterminated triple quoted string",
    },
    "tab_error": {
        "in cause": "A `TabError` indicates that you have used",
        title: "TabError",
    },
    "unescaped_backslash": {
        "in cause": "Did you forget to escape a backslash character",
        title: "EOL unescaped backslash",
    },
    "use_backquote": {
        "in cause": "use the function `repr(x)`.",
        title: "Using the backquote character",
    },
    "unicode_error": {
        "in cause": "one backslash character, `\\` followed by an uppercase `U`",
        title: "unicode error",
    },
    "walrus_instead_of_equal": {
        "in cause": "You use the augmented assignment operator `:=` where",
        title: "Walrus instead of equal",
        "also in cause": ["the normal assignment operator `=` was required."],
    },
    "while_missing_condition": {
        "in cause": "A `while` loop requires a condition",
        title: "Missing condition in while statement",
    },
    "would_be_type_declaration_1": {
        "in cause": "You do not need to declare variables in Python.",
...
if sys.version_info < (3, 8):
    ...
    descriptions["debug_fstring_not_supported"] = {
        "in cause": "You are likely using a 'debug' syntax of f-strings",
        title: "Debug-feature of f-string not supported",
    }

    descriptions["fstring_assign_value"] = {
        "in cause": "You are likely trying to assign a value within an f-string.",
